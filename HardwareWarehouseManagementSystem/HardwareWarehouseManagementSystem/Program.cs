...
namespace HardwareWarehouseManagementSystem
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            hardwareItemQueue.AddItem(new Paintbrush { Id = 5, Name = "Paintbrush 1", Type = "Paintbrush", UnitValue = 5.00m, Quantity = 100 });
            System.Threading.Thread.Sleep(3000);

            hardwareItemQueue.AddItem(new Paintbrush { Id = 6, Name = "Paintbrush 2", Type = "Paintbrush", UnitValue = 5.00m, Quantity = 100 });
            System.Threading.Thread.Sleep(3000);

            hardwareItemQueue.AddItem(new Paintbrush { Id = 7, Name = "Paintbrush 3", Type = "Paintbrush", UnitValue = 5.00m, Quantity = 100 });
            System.Threading.Thread.Sleep(3000);
        ...
        private static void WriteValuesInQueueToScreen(CustomQueue<HardwareItem> hardwareItems)
        {
            ...
            {
                Console.WriteLine($"{hardwareItem.Id,-6}" +
                                  $"{hardwareItem.Name,-15}" +
                                  $"{hardwareItem.Type,-20}" +
                                  $"{hardwareItem.Quantity,10}" +
                                  $"{hardwareItem.UnitValue,10}");
            }
        }
